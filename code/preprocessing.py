...
print("=" * 50)
print("PART 1: CPS Data Cleaning")
print("=" * 50)

# Load CPS data
cps_file_path = RAW_DATA_DIR / "CPS_data.csv"
print(f"Reading CPS data from: {cps_file_path}")
...
print(f"High schools retained: {len(df_hs)}")
...
print("\n" + "=" * 50)
print("PART 2: ACS Data Download")
print("=" * 50)
...
print(f"Total tracts: {n_before} → after dropna: {n_after}")
...
print(f"Tracts after cleaning: {len(df_clean)}")
...
print(df_clean[["GEOID", "NAME", "disadvantage_score"]]
      .sort_values("disadvantage_score", ascending=False)
      .head(10).to_string(index=False))

print("\n=== Top 10 Least Disadvantaged Tracts ===")
print(df_clean[["GEOID", "NAME", "disadvantage_score"]]
      .sort_values("disadvantage_score", ascending=True)
      .head(10).to_string(index=False))
...
print(f"\nPCA results saved to: {acs_pca_path}")